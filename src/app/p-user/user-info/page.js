...
function page() {
  return (
    ...
    >
      ...
      <form action="#" id={styles["edit-info"]}>
        {/* <!-- نام و نام خانوادگی --> */}
        <div className={styles["form-items"]}>
          ...
          <div className={styles["input-wrapper"]}>
            <div className={styles["input-right"]}>
              ...
              <input type="text" name="name" id={styles["name-family"]} />
            </div>
            <div className={styles["edit-btn"]}>
              ...
              >
                ...
                ></path>
                <path
                  d="M8.49935 18.19C7.88935 18.19 7.32935 17.97 6.91935 17.57C6.42935 17.08 6.21935 16.37 6.32935 15.62L6.75935 12.61C6.83935 12.03 7.21935 11.28 7.62935 10.87L15.5093 2.99C17.4993 0.999998 19.5193 0.999998 21.5093 2.99C22.5993 4.08 23.0893 5.19 22.9893 6.3C22.8993 7.2 22.4193 8.08 21.5093 8.98L13.6293 16.86C13.2193 17.27 12.4693 17.65 11.8893 17.73L8.87935 18.16C8.74935 18.19 8.61935 18.19 8.49935 18.19ZM16.5693 4.05L8.68935 11.93C8.49935 12.12 8.27935 12.56 8.23935 12.82L7.80935 15.83C7.76935 16.12 7.82935 16.36 7.97935 16.51C8.12935 16.66 8.36935 16.72 8.65935 16.68L11.6693 16.25C11.9293 16.21 12.3793 15.99 12.5593 15.8L20.4393 7.92C21.0893 7.27 21.4293 6.69 21.4793 6.15C21.5393 5.5 21.1993 4.81 20.4393 4.04C18.8393 2.44 17.7393 2.89 16.5693 4.05Z"
                  fill="#831FC1"
                ></path>
                <path
                  d="M19.8496 10.33C19.7796 10.33 19.7096 10.32 19.6496 10.3C17.0196 9.56 14.9296 7.47 14.1896 4.84C14.0796 4.44 14.3096 4.03 14.7096 3.91C15.1096 3.8 15.5196 4.03 15.6296 4.43C16.2296 6.56 17.9196 8.25 20.0496 8.85C20.4496 8.96 20.6796 9.38 20.5696 9.78C20.4796 10.12 20.1796 10.33 19.8496 10.33Z"
                  fill="#831FC1"
                ></path>
              </svg>
            </div>
        ...
        <div className={styles["form-items"]}>
          ...
          <div className={styles["input-wrapper"]}>
            <div className={styles["input-right"]}>
              ...
              <input type="text" id={styles["location"]} />
            </div>
            <div className={styles["edit-btn"]}>
              <svg
                width="24"
        ...
        <div className={styles["form-items"]}>
          ...
          <div className={styles["input-wrapper"]}>
            <div className={styles["input-right"]}>
              ...
              <input type="text" id={styles["post"]} />
            </div>
            <div className={styles["edit-btn"]}>
              <svg
                width="24"
