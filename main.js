    ...
    <div className={styles["admin-page"]}>
      <div className={styles["admin-page__content"]}>
        <div className={styles["comments-wrapper"]}>
          ...
          <div className={styles["comments-tablee"]}>
            <div className={styles["product-table-filter"]}>
              <div className={styles["filters-logo"]}>
            ...
            <table className={styles["comments-table"]}>
              ...
              <tbody>
                <tr>
                  ...
                  <td>کنسول سونی مدل Ps5 Slim</td>
                  <td> 1404/12/15 </td>
                  <td> 4.8 </td>
                  <td>
                    <div className={styles["show-comments-btn"]}>
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                  ...
                  <td>
                    <div className={styles["accept-comments-btn"]}>
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
